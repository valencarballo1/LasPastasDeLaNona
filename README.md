...
La web se ve terminada aunque no haya ninguna foto cargada: las secciones que dependen de imágenes se adaptan o no se muestran, en vez de dejar marcos vacíos ocupando pantalla.
